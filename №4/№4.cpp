//19.
//Реализовать с использованием массива однонаправленное кольцо (просмотр возможен справа налево, от первого элемента можно перейти к последнеу).
//Распечатать полученный массив, начиная с К-ого элеменгта и до К+1.
//Добавить в кольцо первый и последний элементы.
//Удалить из кольца нечетные элементы.
//Распечать полученный массив, начиная с К-ого элемента и до К+1.
